...
1. **`similarity.pkl`**: [Download here]https://drive.google.com/drive/folders/1ISNzXPmulOyaOhP7noUn14KfZIYJ3T4N?usp=sharing
...
- **Recommendation Page**:
  ![Recommendation Screenshot](#add_screenshot_url)
